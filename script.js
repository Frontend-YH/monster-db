...
const monsterObject = {
    monster: [
        {
            name: 'Tentacel',
            img: 'https://i.ibb.co/6JQdL1h/monster-img4-removebg-preview.png',
            color: 'Yellow',
            type: 'Mid',
        },
        {
            name: 'Basilisk',
            img: 'https://i.ibb.co/DgMNwVJ/monster-img3.png',
            color: 'Green',
            type: 'Large',
        },
        {
            name: 'Beelzebub',
            img: 'https://i.ibb.co/SrL1bH1/monster-img8-removebg-preview.png',
            color: 'Black',
            type: 'Small',
        },
        {
            name: 'Automatons',
            img: 'https://i.ibb.co/xjDgVw8/monster-img7.png',
            color: 'Pink',
            type: 'Large',
        },
        {
            name: 'Husmonstret',
            img: 'https://i.ibb.co/fx6hxkP/monster-img5.png',
            color: 'Pink',
            type: 'Mid',
        },
        {
            name: 'Skabbjörnen',
            img: 'https://i.ibb.co/mJDJrGw/monster-img2.png',
            color: 'Green',
            type: 'Mid',
        },
        {
            name: 'Crawler',
            img: 'https://i.ibb.co/d0sM3WL/monster-img.png',
            color: 'Green',
            type: 'Small',
        },
        {
            name: 'Orb',
            img: 'https://i.ibb.co/1nWmxLY/monster-img6.png',
            color: 'Brown',
            type: 'Mid',
        },
